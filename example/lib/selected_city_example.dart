...
import 'package:phoenix_selectcity/phoenix_selectcity.dart';

class CitySelectRoute extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return _CitySelectRouteState();
  }
}

class _CitySelectRouteState extends State<CitySelectRoute> {
  final List<SelectCityModel> _cityList = [];
  final List<SelectCityModel> _hotCityList = [];
  ...
  void loadData() async {
    _hotCityList.add(SelectCityModel(name: "北京市", tagIndex: "★"));
    //加载城市列表
      ...
      children: <Widget>[
        ...
        Container(
          ...
          child: Align(
            ...
            child: Text(
              model.name,
              style: const TextStyle(color: Color(0xff101D37), fontSize: 16),
            ),
          ),
        ),
